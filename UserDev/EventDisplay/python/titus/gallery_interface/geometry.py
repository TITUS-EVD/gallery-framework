...
class icarus(Geometry):
    ...
    def __init__(self, geometryCore=None, detProperties=None, detClocks=None, lar_properties=None, no_split_wire=False):
        ...
        self._name = "icarus"
        self._logo = LOGO_PATH / "logo_icarus.png"
        self._logoRatio = 1.0
        self._haslogo = False
        self._logopos = [30, 30]
...
class microboone(Geometry):
    ...
    def __init__(self):
        ...
        self._name = "uboone"
        self._logo = LOGO_PATH / "uboone_logo_bw_transparent.png"
        self._logoRatio = 1.0
        self._haslogo = True
...
class lariat(Geometry):
    ...
    def __init__(self):
        ...
        self._name = "lariat"
        # Get the logo too!
        self._logo = LOGO_PATH / "LArIAT_simple_outline.png"
        self._haslogo = True
