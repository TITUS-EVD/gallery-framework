...
from gallery_interface.datatypes.connectedObjects import connectedBox, connectedCircle, boxCollection
...
class match(recoBase):
    ...
    def __init__(self, geom):
        ...
        self._process = evd.DrawMatch(geom.getGeometryCore(), geom.getDetectorProperties(), geom.getDetectorClocks())
        self.init()
