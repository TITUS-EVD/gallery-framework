...
class SpacepointHits(Drawable):
    ...
    def __init__(self, gallery_interface, geom, tpc_module, *args, **kwargs):
        ...
        self._process = evd.DrawSpacepointHits(geom.getGeometryCore(), geom.getDetectorProperties(), geom.getWireReadout(), geom.getDetectorClocks())
        self._geom = geom
