...
from gallery_interface.datatypes.track import polyLine
...
class numuselection(recoBase):
    ...
    def __init__(self, geom):
        ...
        self._process = evd.DrawNumuSelection(geom.getGeometryCore(), geom.getDetectorProperties(),geom.getWireReadout(), geom.getDetectorClocks())
        self._brush = (0, 0, 0)
        self.init()
