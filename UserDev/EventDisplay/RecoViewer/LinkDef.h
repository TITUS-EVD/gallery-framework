...
#pragma link C++ class evd::MCTruth+;
#pragma link C++ class std::vector<::evd::MCTruth>+;
#pragma link C++ class evd::RecoBase<evd::MCTruth>+;
...
#pragma link C++ class evd::NumuSelection2D+;
#pragma link C++ class std::vector<::evd::NumuSelection2D>+;
