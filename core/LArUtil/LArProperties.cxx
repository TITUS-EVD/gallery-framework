...
void LArProperties::ClearData()
{
    ...
    fElectronlifetime = galleryfmwk::data::kINVALID_DOUBLE;
    fRadiationLength = galleryfmwk::data::kINVALID_DOUBLE;
    fArgon39DecayRate = galleryfmwk::data::kINVALID_DOUBLE;
    fZ = galleryfmwk::data::kINVALID_DOUBLE;
    fA = galleryfmwk::data::kINVALID_DOUBLE;
    fI = galleryfmwk::data::kINVALID_DOUBLE;
    fSa = galleryfmwk::data::kINVALID_DOUBLE;
    fSx0 = galleryfmwk::data::kINVALID_DOUBLE;
    fSx1 = galleryfmwk::data::kINVALID_DOUBLE;
    fScbar = galleryfmwk::data::kINVALID_DOUBLE;
    ...
    fProtonScintYield = galleryfmwk::data::kINVALID_DOUBLE;
    fProtonScintYieldRatio = galleryfmwk::data::kINVALID_DOUBLE;
    fPionScintYield = galleryfmwk::data::kINVALID_DOUBLE;
    fPionScintYieldRatio = galleryfmwk::data::kINVALID_DOUBLE;
    fMuonScintYield = galleryfmwk::data::kINVALID_DOUBLE;
    fMuonScintYieldRatio = galleryfmwk::data::kINVALID_DOUBLE;
    fKaonScintYield = galleryfmwk::data::kINVALID_DOUBLE;
    fKaonScintYieldRatio = galleryfmwk::data::kINVALID_DOUBLE;
    fElectronScintYield = galleryfmwk::data::kINVALID_DOUBLE;
    fElectronScintYieldRatio = galleryfmwk::data::kINVALID_DOUBLE;
    fAlphaScintYield = galleryfmwk::data::kINVALID_DOUBLE;
    fAlphaScintYieldRatio = galleryfmwk::data::kINVALID_DOUBLE;
    fScintYield = galleryfmwk::data::kINVALID_DOUBLE;
    fScintResolutionScale = galleryfmwk::data::kINVALID_DOUBLE;
    fScintFastTimeConst = galleryfmwk::data::kINVALID_DOUBLE;
    fScintSlowTimeConst = galleryfmwk::data::kINVALID_DOUBLE;
    fScintYieldRatio = galleryfmwk::data::kINVALID_DOUBLE;
    fScintBirksConstant = galleryfmwk::data::kINVALID_DOUBLE;
