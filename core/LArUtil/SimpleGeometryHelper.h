/**
 * \file SimpleGeometryHelper.h
 *
 * \ingroup LArUtil
 *
 * \brief Class def header for a class SimpleGeometryHelper
 *
 * @author cadams + david caratelli + Marco Del Tutto
 */

/** \addtogroup LArUtil

    @{*/
#ifndef GALLERY_FMWK_SIMPLEGEOMETRYHELPER_H
#define GALLERY_FMWK_SIMPLEGEOMETRYHELPER_H
