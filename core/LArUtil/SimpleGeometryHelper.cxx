#ifndef GALLERY_FMWK_SIMPLEGEOMETRYHELPER_CXX
#define GALLERY_FMWK_SIMPLEGEOMETRYHELPER_CXX

#include "SimpleGeometryHelper.h"
...
Point2D SimpleGeometryHelper::Point_3Dto2D(const TVector3 & _3D_position, unsigned int plane, unsigned int tpc_, unsigned int cryo_) const {
  ...
  planeOrigin[0] = 0;//vtx.X();
  planeOrigin[1] = 0;//vtx.Y();
  planeOrigin[2] = 0;//vtx.Z();
...
TVector3 SimpleGeometryHelper::Project_3DLine_OnPlane(const TVector3& inputVector, const TVector3& planeNormal) const {
...
TVector3 SimpleGeometryHelper::Project_3DLine_OnPlane(const TVector3& inputVector, const int& pl) const {
...
std::vector<double> SimpleGeometryHelper::Project_3DLine_OnPlane(const std::vector<double>& V, const std::vector<double>& N) const {
...
std::vector<double> SimpleGeometryHelper::Project_3DLine_OnPlane(const std::vector<double>& V, const int& pl) const {
...
float SimpleGeometryHelper::DistanceToLine2D( const Point2D & pointOnLine, const Point2D & directionOfLine,
...
float SimpleGeometryHelper::DistanceToLine2D( const TVector2 & pointOnLine, const TVector2 & directionOfLine,
...
float SimpleGeometryHelper::DistanceToLine3D( const TVector3 & pointOnLine, const TVector3 & directionOfLine,
...
float SimpleGeometryHelper::DistanceAlongLine3D(
...
float SimpleGeometryHelper::Get2DDistanceSqrd(const Point2D& point1, const Point2D& point2) const
{
  return (point1.w - point2.w) * (point1.w - point2.w) + (point1.t - point2.t) * (point1.t - point2.t);
}


float SimpleGeometryHelper::Get2DDistance(const Point2D& point1, const Point2D& point2) const
{
  return TMath::Sqrt(Get2DDistanceSqrd(point1, point2));
}

int SimpleGeometryHelper::GetPointOnLine(const double& slope,
...
double SimpleGeometryHelper::GetPitch(const TVector3& direction, const int& pl) const
{
...
double SimpleGeometryHelper::CalculatePitch(UInt_t pl, double phi, double theta) const
{
...
double SimpleGeometryHelper::PitchInView(UInt_t plane, double phi, double theta) const
{
...
void SimpleGeometryHelper::GetDirectionCosines(double phi, double theta, Double_t *dirs) const
...
double SimpleGeometryHelper::GetCosAngleBetweenLines(const double& s1, const double& s2) const
{
...
double SimpleGeometryHelper::GetCosAngleBetweenLines(const Point2D& p1, const Point2D& p2, const Point2D& p3) const
{
...
double SimpleGeometryHelper::GetCosAngleBetweenLines(const Point2D& p1, const Point2D& p2,
...
double SimpleGeometryHelper::GetTanAngleBetweenLines(const double& s1, const double& s2) const
{
...
void SimpleGeometryHelper::SelectPolygonHitList(const std::vector<Hit2D> &inputHits,
...
std::vector<size_t>  SimpleGeometryHelper::OrderPolygonEdges( std::vector<const Hit2D*> ordered_hits ,
...
bool SimpleGeometryHelper::Clockwise(const double& Ax, const double& Ay,
...
double SimpleGeometryHelper::PerpendicularDistance(const Point2D& pt,
    const double& slope,
...
std::vector<unsigned int> SimpleGeometryHelper::SelectLocalPointList( const std::vector<Hit2D> & inputHits,
...
int SimpleGeometryHelper::GetYZ(const Point2D *p0, const Point2D *p1, Double_t* yz) const
{
